...
{
    XamlApplication::XamlApplication(winrt::Windows::Foundation::Collections::IVector<winrt::Microsoft::UI::Xaml::Markup::IXamlMetadataProvider> providers)
    {
    ...
    void XamlApplication::Initialize()
    {
        ...
        if (out)
        {
            winrt::Microsoft::UI::Xaml::Markup::IXamlMetadataProvider provider(nullptr);
            winrt::check_hresult(out->QueryInterface(
                winrt::guid_of<winrt::Microsoft::UI::Xaml::Markup::IXamlMetadataProvider>(),
    ...
    xaml::Markup::IXamlType XamlApplication::GetXamlType(winrt::Windows::UI::Xaml::Interop::TypeName const& type)
    {
