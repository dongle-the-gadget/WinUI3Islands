...
namespace Toolkit.XamlHost
{
    ...
    static partial class UWPTypeFactory
    {
        ...
        public static Microsoft.UI.Xaml.FrameworkElement CreateXamlContentByType(string xamlTypeName)
        {
            Microsoft.UI.Xaml.Markup.IXamlType xamlType = null;
            ...
            if (systemType != null)
            {
                ...
                return (Microsoft.UI.Xaml.FrameworkElement)Activator.CreateInstance(systemType);
            }

            if (xamlType != null)
            {
                // Create custom UWP XAML type
                return (Microsoft.UI.Xaml.FrameworkElement)xamlType.ActivateInstance();
            }
